...
const ITALIC_STYLES = FANCY_STYLES.filter((s) =>
  ["italic", "boldItalic", "sansItalic", "sansBoldItalic", "script", "boldScript"].includes(s.id)
);

export function ItalicTextClient() {
