...
const PAGES = [
  ...
  { path: "/qr-code-reader", priority: 0.9 },
  { path: "/qr-code-with-logo", priority: 0.9 },
  { path: "/batch-qr-generator", priority: 0.9 },
  { path: "/image-compressor", priority: 0.9 },
  { path: "/image-cropper", priority: 0.9 },
  { path: "/background-remover", priority: 0.9 },
  { path: "/favicon-generator", priority: 0.9 },
