...
const PUBG_BORDERS = [
  ...
  { label: "ᴘᵤʙɢ Name", wrap: (n: string) => `ᴘᵤʙɢ ${n}` },
  { label: "Name ™", wrap: (n: string) => `${n}™` },
  { label: "ッ Name", wrap: (n: string) => `ッ${n}` },
];

export function PubgNameClient() {
    ...
    <div className="space-y-6">
      <div>
        ...
        <input
          ...
          placeholder="Enter your PUBG name…"
          maxLength={16}
        ...
        />
        <p className="mt-1 text-[11px] text-neutral-400">PUBG Mobile / BGMI allows up to 16 characters in the name field.</p>
      </div>

      <div>
        <h2 className="text-[13px] font-semibold text-foreground mb-3">Styled Names</h2>
      ...
      <div>
        <h2 className="text-[13px] font-semibold text-foreground mb-3">BGMI Border Styles</h2>
        <div className="grid gap-3 sm:grid-cols-2">
          {PUBG_BORDERS.map((border) => {
