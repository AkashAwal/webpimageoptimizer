...
export const TOOL_ICONS: Record<string, React.ReactNode> = {
  ...
  "/tools/readability-score": <BookOpen size={22} />,
  "/tools/syllable-counter": <Hash size={22} />,
  "/tools/reading-time": <Clock size={22} />,
  "/tools/sentence-counter": <Article size={22} />,
  "/tools/text-to-speech": <SpeakerHigh size={22} />,
  "/tools/hash-generator": <Fingerprint size={22} />,
  "/tools/url-parser": <LinkSimple size={22} />,
  "/tools/color-code-converter": <Palette size={22} />,
  "/tools/html-minifier": <Code size={22} />,
  "/tools/markdown-to-html": <Article size={22} />,
  "/tools/grade-calculator": <Certificate size={22} />,
  "/tools/speed-calculator": <Lightning size={22} />,
  "/tools/paint-calculator": <PaintRoll size={22} />,
  "/tools/concrete-calculator": <Cube size={22} />,
  "/tools/fraction-calculator": <Divide size={22} />,
  "/tools/quadratic-formula": <Function size={22} />,
  "/tools/prime-factorization": <Hash size={22} />,
  "/tools/lcm-gcd-calculator": <MathOperations size={22} />,
  "/tools/scientific-notation": <Infinity size={22} />,
  "/tools/pythagorean-theorem": <Triangle size={22} />,
  "/tools/roman-numeral-converter": <TextT size={22} />,
  "/tools/fibonacci-generator": <Infinity size={22} />,
  "/tools/mortgage-calculator": <House size={22} />,
  "/tools/break-even-calculator": <Scales size={22} />,
  "/tools/vat-calculator": <Percent size={22} />,
  "/tools/net-worth-calculator": <Wallet size={22} />,
  "/tools/investment-calculator": <ChartLineUp size={22} />,
  "/tools/budget-calculator": <Notebook size={22} />,
  "/tools/ideal-weight-calculator": <Ruler size={22} />,
  "/tools/body-fat-calculator": <PersonSimpleRun size={22} />,
  "/tools/heart-rate-zones": <Heartbeat size={22} />,
  "/tools/water-intake-calculator": <Drop size={22} />,
  "/tools/macros-calculator": <ForkKnife size={22} />,
  "/tools/due-date-calculator": <Baby size={22} />,
  "/tools/calorie-burn-calculator": <Fire size={22} />,
  "/tools/one-rep-max-calculator": <Barbell size={22} />,
  "/tools/running-pace-calculator": <Stopwatch size={22} />,
  "/tools/sleep-calculator": <Moon size={22} />,
  "/tools/protein-intake-calculator": <Egg size={22} />,
  "/tools/debt-payoff-calculator": <CreditCard size={22} />,
  "/tools/inflation-calculator": <TrendDown size={22} />,
  "/tools/emergency-fund-calculator": <FirstAidKit size={22} />,
  "/tools/compound-interest-calculator": <TrendUp size={22} />,
  "/tools/tip-split-calculator": <UsersFour size={22} />,
  "/tools/retirement-calculator": <ChartLineUp size={22} />,
  "/tools/loan-comparison": <Columns size={22} />,
  "/tools/currency-converter": <Globe size={22} />,
  "/tools/dividend-calculator": <Coins size={22} />,
  "/tools/payback-period": <CalendarBlank size={22} />,
  "/tools/net-present-value": <ChartPie size={22} />,
  "/tools/vo2max-calculator": <Wind size={22} />,
  "/tools/waist-to-hip-ratio": <ArrowsHorizontal size={22} />,
  "/tools/lean-body-mass": <Person size={22} />,
  "/tools/caloric-deficit-calculator": <TrendDown size={22} />,
  "/tools/pregnancy-weight-gain": <Heart size={22} />,
  "/tools/menstrual-cycle-calculator": <CalendarBlank size={22} />,
  "/tools/home-affordability": <House size={22} />,
  "/tools/rent-vs-buy": <House size={22} />,
  "/tools/tax-bracket-calculator": <Percent size={22} />,
  "/tools/after-tax-salary": <Wallet size={22} />,
  "/tools/rule-of-72": <Infinity size={22} />,
  "/tools/debt-to-income-ratio": <Scales size={22} />,
  "/tools/sleep-debt-calculator": <Moon size={22} />,
  "/tools/keto-macro-calculator": <ForkKnife size={22} />,
  "/tools/alcohol-unit-calculator": <Drop size={22} />,
  "/tools/one-mile-run-test": <PersonSimpleRun size={22} />,
  "/tools/fiber-intake-calculator": <Egg size={22} />,
  "/tools/caffeine-calculator": <Lightning size={22} />,
  "/tools/recipe-scaler": <ForkKnife size={22} />,
  "/tools/cooking-unit-converter": <ArrowsClockwise size={22} />,
  "/tools/baking-substitutions": <Shuffle size={22} />,
  "/tools/oven-temperature-converter": <Thermometer size={22} />,
  "/tools/yeast-converter": <Hourglass size={22} />,
  "/tools/butter-converter": <Scales size={22} />,
  "/tools/meat-temperature-guide": <Fire size={22} />,
  "/tools/coffee-ratio-calculator": <Drop size={22} />,
};
