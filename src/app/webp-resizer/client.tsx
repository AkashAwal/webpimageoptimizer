...
export default function WebpResizerClient() {
      ...
      <main className="mx-auto w-full max-w-xl px-6 pb-24 pt-8 sm:px-10">
        ...
        <div className="mt-6 mb-8">
          ...
          <p className="mt-2 text-[14px] text-muted-foreground">
            Resize any image to custom dimensions and export as WebP. Accepts PNG, JPG, GIF, WebP.
          </p>
        </div>
        ...
        <div className="space-y-3">
              ...
              <div className="flex items-center justify-between gap-3 px-4 py-3">
                <div className="min-w-0">
                  ...
                  <p className="mt-0.5 text-[12px] text-muted-foreground">
                    ...
                    {naturalW > 0 && ` · ${naturalW} × ${naturalH}px`}
                  </p>
                </div>
                <button
                  onClick={reset}
            ...
            <div className="rounded-2xl bg-white px-4 py-4 ring-1 ring-black/6 shadow-[0_1px_3px_rgba(0,0,0,0.06)] space-y-3">
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={cn(
                    "mt-5 shrink-0 rounded-lg p-2 transition-colors",
                    lockAspect
          ...
          {file && convertState !== "done" && (
            <SoftPillButton
              ...
              disabled={convertState === "converting" || !width || !height}
