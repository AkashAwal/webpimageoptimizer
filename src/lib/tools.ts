...
export const CATEGORY_METADATA = [
  ...
  },
  {
    ...
    href: "/unit-converter",
    description: "Convert length, weight, and temperature between metric and imperial units instantly — no login, no server, fully in-browser.",
    seoTitle: "Free Unit Converter — Length, Weight, Temperature | Pix Garage",
    seoDescription: "Free in-browser unit converters: length (mm to miles), weight (mg to tons), and temperature (Celsius, Fahrenheit, Kelvin, Rankine). Instant, no signup.",
  },
] as const;
