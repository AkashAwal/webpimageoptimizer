...
const ACCEPTED = {
  "video/*": [".mp4", ".mov", ".avi", ".mkv", ".webm", ".mpeg", ".mpg", ".3gp", ".wmv", ".ogv"],
};

export default function VideoDropzone({ onFiles, disabled }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        {isDragReject ? (
          <p className="text-red-500 font-medium">Only video files are accepted</p>
        ) : isDragActive ? (
          <p className="text-violet-500 font-semibold text-lg">Drop to add videos</p>
        ) : (
          <>
            <div>
              <p className="text-zinc-800 dark:text-zinc-200 font-semibold text-base">Drag & drop videos here</p>
            ...
            <p className="text-gray-300 dark:text-zinc-600 text-xs">
              MP4 · MOV · AVI · MKV · WebM · MPEG — compressed to WebM (VP9)
            </p>
          </>
        )}
      </div>
