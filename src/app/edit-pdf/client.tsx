          ...
          {!file ? (
            ...
            >
              <div className="text-center space-y-1.5">
                <h2 className="text-[22px] font-bold tracking-tight text-foreground">Edit PDF</h2>
                <p className="text-[13px] text-muted-foreground">Annotate, highlight, and draw on any page of a PDF.</p>
              </div>
              <button
