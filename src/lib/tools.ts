...
export const CATEGORY_METADATA = [
  ...
  },
  {
    ...
    label: "Calculators",
    href: "/calculators",
    description: "Percentage, tip, BMI, compound interest, and loan calculators — all free, in-browser, no signup. Instant results as you type.",
    seoTitle: "Free Online Calculators — Percentage, Tip, BMI, Loan & More | Pix Garage",
    seoDescription: "Free in-browser calculators: percentage calculator, tip and bill splitter, BMI calculator, compound interest, and loan payment calculator with amortization. No signup.",
  },
] as const;
