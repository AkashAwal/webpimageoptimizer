          ...
          {!file ? (
            ...
            >
              <div className="text-center space-y-1.5">
                <h2 className="text-[22px] font-bold tracking-tight text-foreground">Sign PDF</h2>
                <p className="text-[13px] text-muted-foreground">Draw or type your signature onto any page of a PDF.</p>
              </div>
              <button
